...
package com.pblabs.engine.entity
{
    ...
    {        
        ...
        public function getProperty(property:PropertyReference, defaultVal:* = null):*
        {
			...
			if(property.cachedInfo && property.property.indexOf("#Game") == -1 && ((property.cachedInfo.propertyParent is IEntityComponent) && (property.cachedInfo.propertyParent as IEntityComponent).isRegistered) && !PBE.IN_EDITOR){
