...
package starling.display
{
    ...
    public class DisplayObjectContainer extends DisplayObject
    {
		...
		/** Returns all objects that are found beneath a point in local coordinates, or empty Array if 
		 *  none found. If "forTouch" is true, untouchable and invisible objects will cause
		 *  the test to fail. */
		public function getObjectsUnderPoint(localPoint:Point, forTouch:Boolean=false):Array
		{
