...
package starling.textures
{
	...
	public class Texture
	{
		...
		public static function fromEmbeddedAsset(assetClass:Class, mipMapping:Boolean=false,
												 ...
												 forcePotTexture:Boolean=false, async:Function=null):Texture
		{
			var texture:Texture;
			...
			if (asset is Bitmap)
			{
				texture = Texture.fromBitmap(asset as Bitmap, mipMapping,
					optimizeForRenderToTexture, scale, format, forcePotTexture, async);
				texture.root.onRestore = function():void
				{
			...
			{
				texture = Texture.fromAtfData(asset as ByteArray, scale, mipMapping, async);
				texture.root.onRestore = function():void
				{
