...
package starling.text
{
    ...
    public class TextField extends DisplayObjectContainer
    {
		...
		private var _customScaleFactor : Number = -1;
        ...
        private function updateText():void
        {
            ...
            _options.textureScale = _customScaleFactor != -1 ? _customScaleFactor : Starling.contentScaleFactor;
		 ...
		 *  @default -1 */
		public function get customScaleFactor():Number { return _customScaleFactor; }
		public function set customScaleFactor(value:Number):void
		{ 
			if (_customScaleFactor != value)
			{
				_customScaleFactor = value;
